    ...
    return (
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:px-20 px-10'>
          <div className='hidden lg:block'>
              <Image src="https://i.postimg.cc/Y9G9Q4Tp/banner-1.png" width={500} height={500} alt="banner"/>
          </div>
          <div className="lg:w-11/12">
              ...
              <div className='flex lg:flex-row flex-col-reverse place-items-center lg:justify-start justify-end mb-10'>
                  <div className='lg:basis-1/2 flex flex-col lg:place-items-start place-items-center justify-center lg:mr-10'>
                    <div className='flex flex-row place-items-center mb-5'>
                      <Image src="https://i.postimg.cc/Yq9pFLFT/account.png" width={45} height={45} alt="" />
                  ...
                  <Image src="https://s12.gifyu.com/images/Sfb2B.gif" width={140} height={140} alt=""/>
              </div>
              <div className='flex lg:flex-row flex-col-reverse place-items-center lg:justify-start justify-end mb-10'>
                  <div className='lg:basis-1/2 flex flex-col lg:place-items-start place-items-center justify-center lg:mr-10'>
                    <div className='flex flex-row place-items-center mb-5'>
                      <Image src="https://i.postimg.cc/nzcKx1s3/money.png" width={45} height={45} alt="" />
              ...
              <div className='flex lg:flex-row flex-col-reverse place-items-center lg:justify-start justify-end mb-10'>
                  <div className='lg:basis-1/2 flex flex-col lg:place-items-start place-items-center justify-center lg:mr-10'>
                    <div className='flex flex-row place-items-center mb-5'>
                      <Image src="https://i.postimg.cc/XvghxQSL/choose.png" width={45} height={45} alt="" />
